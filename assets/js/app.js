...
document.getElementById("credits").innerHTML = `<span style='float:left;position:relative;margin-top:35%;margin-left:90.5%;color:white;font-size:16px'>Made by <a href="https://twitter.com/Glazelfy" target="_blank">Glaze</a> of the</span>`;
